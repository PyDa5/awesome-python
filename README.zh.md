...
一个专门收录优秀Python框架、库、软件和资源清单的项目。

项目灵感来自 [awesome-php](https://github.com/ziadoz/awesome-php).
...
- [Awesome Python](#awesome-python)
    ...
    - [命令行应用开发](#命令行应用开发)
    - [命令行工具](#命令行工具)
    - [Python2与Python3兼容性](#Python2与Python3兼容性)
    - [计算机视觉](#计算机视觉)
    - [并发与并行](#并发与并行)
    - [配置文件](#配置文件)
    - [密码学](#密码学)
    ...
    - [HTTP客户端](#HTTP客户端)
    - [图像处理](#图像处理)
    - [Python的其它实现](#Python的其它实现)
    - [交互式Python解释器](#交互式Python解释器)
    - [国际化](#国际化)
    - [任务调度](#任务调度)
    - [日志](#日志)
    - [机器学习](#机器学习)
...
随时欢迎你来贡献代码! 贡献代码请先阅读 [贡献向导](https://github.com/vinta/awesome-python/blob/master/CONTRIBUTING.md).

如果我不确定某些库是否特别优秀，我会开启pull requests来征集大家的意见, 你可以通过点赞:+1:  [为其投票](https://github.com/vinta/awesome-python/pulls) . 当pull requests投票数超过20票的时，将会被awesome-python收录.

- - -

如果你对这份清单有任何问题, 请毫不犹豫地通过Twitter[@VintaChen](https://twitter.com/VintaChen)联系我或者在GitHub上开一个issue来反馈(open an issue).
